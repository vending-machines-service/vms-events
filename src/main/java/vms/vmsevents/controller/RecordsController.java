...
public class RecordsController {
	...
	public List<RecordArchiveDTO> getArchiveMalFunctionRecord(
			@RequestParam(name = "from", defaultValue = "2010-01-01") String from,
	...
	public List<RecordArchiveDTO> getArchiveMaintenanceRecord(
			@RequestParam(name = "from", defaultValue = "2010-01-01") String from,
			@RequestParam(name = "to", defaultValue = "now") String to) {
		DateTimeFormatter format = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		if (to.equals("now")) {
	...
	public List<RecordArchiveDTO> getAllArchiveRecord(
			@RequestParam(name = "from", defaultValue = "2010-01-01") String from,
			@RequestParam(name = "to", defaultValue = "now") String to) {
		DateTimeFormatter format = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		if (to.equals("now")) {
